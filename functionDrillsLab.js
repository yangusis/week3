...
let jsNinja = () => { console.log("I am a JavaScript ninja!") } // return "I am a JavaScript ninja!"

// not sure if it wanted to me to return the String or print it to the console
//console.log(jsNinja())
jsNinja()
...
// not sure how to make the output look cleaner than calling a console log for both results
...
var nameGreeting = nameCheck("Fred")
...
var colorRating = console.log(faveColorFinder("red"))
...
var oddChecker = console.log(thatsOdd(2))
...
let bestMovie = (title) => { return title + " is the best movie ever!" }
console.log(bestMovie("test"))
...
var arrayEvaluator = console.log(bigOrSmall(bigOrSmallArray))
...
console.log(emailCheck("idk@yahoo"))
...
function choco(gold) {
  var frogs = Math.floor(gold / 3)

  return frogs
}

var totalFrogs = console.log(choco(100))
...
// took a lot longer than I wanted it to. also very messy, don't love how it looks
...
var arrayIsAscending = console.log(take(sampleArray))
